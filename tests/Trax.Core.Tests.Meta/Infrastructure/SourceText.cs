namespace Trax.Core.Tests.Meta.Infrastructure;
...
internal static class SourceText
{
    ...
    /// <summary>
    /// Strips comments and string literals so that regex-based pattern matching against C# source
    /// does not get false positives from a token appearing inside a documentation comment or string.
    /// </summary>
