...
namespace ReSharperPlugin.Trax.Core.Hints
{
    ...
    [DaemonAdornmentProvider(typeof(ChainJunctionAdornmentProvider))]
    ...
    public class ChainJunctionInlayHint : ChainJunctionInlayHintBase
    {
        public const string HighlightAttributeId = nameof(ChainJunctionInlayHint);

        public string HintText { get; }

        public ChainJunctionInlayHint(
            string hintText,
            ITreeNode node,
